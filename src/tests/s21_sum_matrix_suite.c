...
START_TEST(sum_matrix_0) {
  ...
  fill_matrix(4, &m);
  fill_matrix(3, &n);
  int error = s21_sum_matrix(&m, &n, &res);
  ...
  ck_assert_double_eq(res.matrix[0][2], 11);
  s21_remove_matrix(&m);
  s21_remove_matrix(&n);
...
Suite *suite_s21_sum(void) {
  Suite *s12;
  TCase *tc12;
  s12 = suite_create("s21_sum");
  tc12 = tcase_create("case_sum");

  tcase_add_test(tc12, sum_matrix_0);
  tcase_add_test(tc12, sum_matrix_1);
  tcase_add_test(tc12, sum_matrix_2);
  tcase_add_test(tc12, sum_matrix_3);
  tcase_add_test(tc12, sum_matrix_4);
  tcase_add_test(tc12, sum_matrix_5);
  tcase_add_test(tc12, sum_matrix_6);
  tcase_add_test(tc12, sum_matrix_7);
  tcase_add_test(tc12, sum_matrix_8);
